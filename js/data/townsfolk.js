...
window.TOWNSFOLK = [
  ...
  { id: 'aide', name: 'Kern', cls: 'Lab Aide', loc: 'town', kind: 'talk',
  ...
  /* ---- The Compiler Café ------------------------------------------------- */
  { id: 'barista', name: 'Mo', cls: 'Barista', loc: 'cafe', kind: 'talk',
  ...
  { id: 'dax', name: 'Dax', cls: 'Café Regular', loc: 'cafe', kind: 'trainer', ch: 5, team: [63, 100], pay: 150,
  ...
  { id: 'kip', name: 'Kip', cls: 'Waiter', loc: 'cafe', kind: 'gift', item: 'potion', amount: 1,
  ...
  /* ---- Meadow Route ------------------------------------------------------ */
  { id: 'ari', name: 'Ari', cls: 'Bug Catcher', loc: 'meadow', kind: 'trainer', ch: 14, team: [10, 13], pay: 70,
  ...
  { id: 'flo', name: 'Flo', cls: 'Bug Catcher', loc: 'meadow', kind: 'trainer', ch: 14, team: [265, 401], pay: 75,
  ...
  { id: 'quill', name: 'Quill', cls: 'Note Taker', loc: 'meadow', kind: 'gift', item: 'great', amount: 1,
    say: 'Found this in the grass. I do not catch things, I just write about them.' },

  /* ---- Riverside Pier ---------------------------------------------------- */
  { id: 'oz', name: 'Oz', cls: 'Fisherman', loc: 'pier', kind: 'trainer', ch: 7, team: [129, 118], pay: 110,
    say: 'Been out here since dawn. Caught one boot and a cold.',
    win: 'That is about how the day was going.', lose: 'First win all week!' },
  { id: 'sal', name: 'Sal', cls: 'Fisherman', loc: 'pier', kind: 'trainer', ch: 7, team: [72, 116], pay: 115,
  ...
  { id: 'wade', name: 'Wade', cls: 'Fisherman', loc: 'pier', kind: 'gift', item: 'great', amount: 2,
    say: 'Bought a box of these and I only ever use the red ones. Take a couple.' },

  /* ---- Stack Ridge ------------------------------------------------------- */
  { id: 'burl', name: 'Burl', cls: 'Hiker', loc: 'ridge', kind: 'trainer', ch: 8, team: [74, 95], pay: 130,
    say: 'I carry everything I need. It is heavy and it is contiguous.',
    win: 'Lighter load going down.', lose: 'Solid. Like the rock.' },
  { id: 'crag', name: 'Crag', cls: 'Hiker', loc: 'ridge', kind: 'trainer', ch: 8, team: [246, 111], pay: 135,
  ...
  { id: 'moss', name: 'Moss', cls: 'Ranger', loc: 'ridge', kind: 'gift', item: 'superpotion', amount: 1,
  ...
  /* ---- The Archive ------------------------------------------------------- */
  { id: 'libr', name: 'Vell', cls: 'Archivist', loc: 'archive', kind: 'talk',
  ...
  { id: 'ink', name: 'Ink', cls: 'Copyist', loc: 'archive', kind: 'trainer', ch: 11, team: [235, 175], pay: 165,
  ...
  { id: 'null', name: 'Nils', cls: 'Cave Guide', loc: 'cavern', kind: 'talk',
  ...
  { id: 'leak', name: 'Sump', cls: 'Caver', loc: 'cavern', kind: 'trainer', ch: 10, team: [88, 316], pay: 195,
  ...
  { id: 'geo', name: 'Geode', cls: 'Miner', loc: 'cavern', kind: 'trainer', ch: 14, team: [74, 525], pay: 175,
  ...
  { id: 'lamp', name: 'Wick', cls: 'Lamplighter', loc: 'cavern', kind: 'gift', item: 'ultra', amount: 1,
  ...
  { id: 'sci-oak', badges: 10, name: 'Dr. Oakes', cls: 'Archivist Emeritus', loc: 'lab', kind: 'talk',
  ...
  /* ---- Gym Quarter ------------------------------------------------------- */
  { id: 'ace1', name: 'Corin', cls: 'Ace Trainer', loc: 'quarter', kind: 'trainer', ch: 4, team: [68, 62], pay: 230,
    say: 'Everyone here is warming up for the same door you are.',
    win: 'Go on, then. Knock.', lose: 'Another lap of the quarter for you.' },
  { id: 'ace2', badges: 12, name: 'Delia', cls: 'Ace Trainer', loc: 'quarter', kind: 'trainer', ch: 12, team: [208, 212], pay: 235,
